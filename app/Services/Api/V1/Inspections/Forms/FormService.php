...
class FormService extends Service
{
    ...
    {
        return [
            'ct_inspection_code' => 'code',
            'sections' => [
                [
                    'ct_inspection_section' => 'Escala de Condición',
                    'sub_sections' => [],
                    'fields' => [
                        [
                            'ct_inspection_form' => 'Escala de Condición',
                            'required' => true,
                        ],
                    ],
                ],
                [
                    'ct_inspection_section' => 'Conclusión De Inspección',
                    'sub_sections' => [],
                    'fields' => [
                        [
                            'ct_inspection_form' => 'Conclusión de Inspección',
                            'required' => true,
                        ],
                    ],
                ],
                [
                    'ct_inspection_section' => 'Acciones Recomendadas',
                    'sub_sections' => [],
                    'fields' => [
                        [
                            'ct_inspection_form' => 'Acciones Recomendadas',
                            'required' => true,
                        ],
                    ],
                ],
                [
                    'ct_inspection_section' => 'Apéndice',
                    'sub_sections' => [
                        [
                            'ct_inspection_section' => 'Normal',
                            'fields' => [
                                [
                                    'ct_inspection_form' => 'normal',
                                    'required' => true,
                                ],
                            ],
                        ],
                        [
                            'ct_inspection_section' => 'Leve',
                            'fields' => [
                                [
                                    'ct_inspection_form' => 'leve',
                                    'required' => true,
                                ],
                            ],
                        ],
                        [
                            'ct_inspection_section' => 'Moderado',
                            'fields' => [
                                [
                                    'ct_inspection_form' => 'moderado',
                                    'required' => true,
                                ],
                            ],
                        ],
                        [
                            'ct_inspection_section' => 'Grave',
                            'fields' => [
                                [
                                    'ct_inspection_form' => 'grave',
                                    'required' => true,
                                ],
                            ],
                        ],
                        [
                            'ct_inspection_section' => 'Peligro',
                            'fields' => [
                                [
                                    'ct_inspection_form' => 'peligro',
                                    'required' => true,
                                ],
                            ],
                        ],
