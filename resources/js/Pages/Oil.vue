...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl  leading-tight">Aceites</h2>
        </template>
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-4 lg:px-6">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <v-card>
                        <v-row>
                            <v-col cols="12" sm="12">
                                <v-data-table :headers="headers" :items="oils" fixed-header :search="search" :mobile="isMobile()">
                                    ...
                                    <template v-slot:top>
                                        <v-toolbar flat>
                                            ...
                                            <v-spacer></v-spacer>
                                            <v-dialog v-model="dialog" max-width="500px" v-if="hasPermissionTo('oils.create') || hasPermissionTo('oils.update')">
                                                <template v-slot:activator="{ props }" v-if="hasPermissionTo('oils.create')">
                                    ...
                                    <template v-slot:item.actions="{ item }">
                                        <v-icon class="me-2" size="small" @click="editItem(item)" v-if="hasPermissionTo('oils.update')">
                                            mdi-pencil
                                        </v-icon>
                                        <v-icon size="small" @click="deleteItem(item)" v-if="hasPermissionTo('oils.delete')">
                                            mdi-delete
                                        </v-icon>
                                    </template>
                                </v-data-table>
