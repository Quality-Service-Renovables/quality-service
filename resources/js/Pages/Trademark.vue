                                ...
                                <v-data-table :headers="headers" :items="trademarks" fixed-header
                                    ...
                                    <template v-slot:top>
                                        <v-toolbar flat>
                                            ...
                                            <v-spacer></v-spacer>
                                            <v-dialog v-model="dialog" max-width="500px" v-if="checkPermission('trademarks.create') || checkPermission('trademarks.update')">
                                                <template v-slot:activator="{ props }" v-if="checkPermission('trademarks.create')">
                                    ...
                                    <template v-slot:item.actions="{ item }">
                                        <v-icon class="me-2" size="small" @click="editItem(item)" v-if="checkPermission('trademarks.update')">
                                            mdi-pencil
                                        </v-icon>
                                        <v-icon size="small" @click="deleteItem(item)" v-if="checkPermission('trademarks.delete')">
                                            mdi-delete
                                        </v-icon>
                                    </template>
                                </v-data-table>
