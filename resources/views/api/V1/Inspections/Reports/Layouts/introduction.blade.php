...
<p class="justify">
    Este informe fue preparado por Quality Service Renovables S. de R.L. de C.V. y se basa en información que no está
    bajo el control de QSR. QSR ha asumido que la información proporcionada por otros, tanto verbal como escrita, es
    completa
    y correcta. Si bien se cree que la información, los datos y las opiniones aquí contenidos serán confiables bajo las
    condiciones y sujetos a las limitaciones establecidas en este documento, QSR no garantiza su exactitud. El uso de
    este
    informe o cualquier información contenida en el mismo por cualquier parte que no sea el destinatario previsto o sus
    afiliados,
    ...
    dicho uso. Además, el uso de este informe o de cualquier información contenida en el mismo por cualquier parte que
    no sea el destinatario previsto o sus
    afiliadas constituirá un acuerdo por parte de dicho tercero para defender e indemnizar a QSR de y contra cualquier
    reclamo
    ...
    relacionadas y
    subcontratistas de cualquier nivel de QSR, y a los directores, funcionarios, socios, empleados y agentes de todas
    las
    partes eximidas o
    indemnizadas.
</p>
